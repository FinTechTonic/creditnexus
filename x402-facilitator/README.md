...
HTTP service that implements **verify** and **settle** for the x402 protocol on the **Aptos** blockchain. Aptos has no public x402 facilitator (CDP, PayAI support Base, Solana, Polygon—not Aptos). This service fills that gap for our system and can be used by any resource server.
